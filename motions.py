...
class motion_executioner(Node):
    ...
    def imu_callback(self, imu_msg: Imu):
        ...
        data = [imu_msg.linear_acceleration.x, 
    ...
    def odom_callback(self, odom_msg: Odometry):
        ...
        # Convert quaternion to euler to get theta (yaw)
    ...
    def make_circular_twist(self):
        # constant-speed circle: v > 0, omega != 0
        msg=Twist()
        msg.linear.x=0.2    # m/s
        msg.angular.z=0.2   # rad/s
        return msg

    def make_spiral_twist(self):
        # simple outward spiral: ramp v up, keep small omega
    ...
    def make_acc_line_twist(self):
        ...
        msg.linear.x=0.0
        msg.linear.y=0.0
        msg.angular.z=0.0 # no turn -> straight
        return msg
