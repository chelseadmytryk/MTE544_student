...
class PID_ctrl:
    ...
    def __init__(self, type_, kp=1.2,kv=0.8,ki=0.2, history_length=3, filename_="errors.csv", log_folder="."):
        ...
        self.logger=Logger(os.path.join(log_folder, filename_))
    ...
    def __update(self, stamped_error):
        ...
        for i in range(1, len(self.history)):
            ...
            error_dot += (self.history[-1][0] - self.history[-2][0]) / dt
        ...
        for hist in self.history:
            sum_ += hist[0]  # Add the error value from each history entry
